            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="card-deck">
                        ...
                        <!--1st card-->
                        <div class="card col-md-4 text-white text-center bg-info">
                            <div class="card-body">
                                <h2 class="card-title font-weight-bold mt-5 mb-5">My Profile</h2>
                            </div>
                            <hr>
                            <div class="card-footer">
                                <a href="./user.php" class="text-white text-center ml-5 mb-3"> View Profile <i class="fas fa-arrow-right ml-1"></i></a>
                            </div>
                        </div>

                        <!--2nd card-->
                        <div class="card col-md-4 text-white text-center bg-primary">
                            <div class="card-body">
                                <h2 class="card-title font-weight-bold mt-5 mb-5">My Room</h2>
                            </div>
                            <hr>
                            <div class="card-footer">
                                <a href="./room.php" class="text-white text-center ml-5 mb-3">View Room Details <i class="fas fa-arrow-right ml-1"></i></a>
                            </div>
                        </div>
