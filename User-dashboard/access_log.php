            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <span class="navbar-brand">User Logs</span>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">User Access logs</h4>
                                    <p class="card-category"> User Loging Time</p>

                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <input class="col-md-2 form-control mb-4" id="tableSearch" type="text" placeholder="Search">
                                        <table class="table table-hover table-bordered css-serial">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="font-weight-bold">Loging Time</th>
                                                </tr>
                                            </thead>
                                            <tbody id='myTable'>
                                                <?php
                                                ...
                                                $query1 = mysqli_query($con, "SELECT * FROM useraccess_log WHERE ID='$uid';");
                                                while ($row = mysqli_fetch_array($query1)) {

                                                    $name = $row["uname"];
                                                    $time = $row["loging_time"];
                ...
                <div class="container-fluid">
                    <nav class="float-left">
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost/Project/aboutus.html">
                                    About Us
                                </a>
                            </li>
                            <li>
