...
{
	$id=intval($_GET['del']);
	$adn="delete from contact where ID=?";
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="h4-responsive card-title">Queries</h4>
                  <p class="card-category">Contacted Queries by the Students</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <input class="col-md-2 form-control mb-4" id="tableSearch" type="text" placeholder="Search" style="position: sticky;">
                    <table class="table table-hover table-bordered">
                      <caption>List of Contacted Queries</caption>
                      <tr>
                        <th class="font-weight-bold">#</th>
                        <th class="font-weight-bold">ID</th>
                        <th class="font-weight-bold">Username</th>
                        <th class="font-weight-bold">Mail ID</th>
                        <th class="font-weight-bold">Phone number</th>
                        <th class="font-weight-bold">Message/Query</th>
                      ...
                      <tbody id="myTable">
                        ...
                        <td><?php echo $row->umessage;?></td>
                        <td><?php echo $row->posting_time;?></td>
                        <td>&nbsp;&nbsp;
                        <a href="Queries.php?del=<?php echo $row->ID;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
                                            </tr>
                                          <?php
                        $cnt=$cnt+1;
                                          } ?>
