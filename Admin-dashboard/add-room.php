...
?>
<div style="position: absolute;visibility:hidden;overflow: hidden">
<?php
$dbuser="root";
$dbpass="";
$host="localhost:3306";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <span class="navbar-brand">ADD ROOM</span>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Creating a room</p>
                </div>
                <div class="card-body">
                <?php if(isset($_POST['submit']))
{ ?>
<span style="color: red;visibility: hidden;" ><?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg']=""); ?></span>
<?php } ?>
                  <form method="POST">
                    <div class="form-row ml-3 mr-3">
                      <div class="form-group col-md-12">
                        <label class="ml-1" for="roomno"><i class="fas fa-door-closed mr-1"></i>Room No.</label>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Enter Room Number" name="rmno" id="roomno" minlength="1" maxlength="4" oninput="checkRoomno()" autocomplete="off" required>
                          <span id="room_number_status" style="font-size:14px;"></span>
                        </div>
                      </div>
                    </div>
                    <div class="form-row ml-3 mr-3">
                      <div class="form-group col-md-12">
                        <label class="ml-1" for="seater"><i class="fas fa-bed mr-1"></i>Select Seater</label>
                        <div class="form-group">
                          <select class="browser-default custom-select" name="seat" required>
                            <option selected disabled value="">Select Seater</option>
                    ...
                    <div class="form-row ml-3 mr-3">
                      <div class="form-group col-md-12">
                        <label class="ml-1"><i class="fas fa-rupee-sign mr-1"></i>Fee(Per Student)</label>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Fee Amount" name="fee" id="fees" minlength="4" maxlength="5" autocomplete="off" required>
                        </div>
                      </div>
                    </div>
...
$("#loaderIconn").show();
jQuery.ajax({
url: "Roomno_status.php",
data:'room_no='+$("#roomno").val(),
type: "POST",
success:function(data){
$("#room_number_status").html(data);
$("#loaderIconn").hide();
},
error:function (){}
});
