...
{
	$id=intval($_GET['del']);
	$adn="DELETE FROM reviews WHERE ID=?";
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="h4-responsive card-title">Reviews</h4>
                  <p class="card-category">Posted Reviews</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    ...
                    <table class="table table-hover table-bordered">
                      ...
                      <tr>
                        ...
                        <th class="font-weight-bold">Posting_time</th>
                      ...
                      <tbody id="myTable">
                        ...
                        <td>&nbsp;&nbsp;
                        <a href="Reviews.php?del=<?php echo $row->ID;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
                                            </tr>
                                          <?php
                        $cnt=$cnt+1;
                                          } ?>
